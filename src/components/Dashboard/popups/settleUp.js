 ...
 class SettleUp extends React.Component{
  ...
  render(){
      ...
      <div className = "pop-btn bt-mr">
        ...
        <button className = "btn cut" onClick = {[]}>Close</button>
    </div>
        </div>
        
        {this.state.paidBy && <PaidBy list = {[]} byValue = {this.byValue.bind(this)}/>}
        {this.state.paidTo && <PaidTo list = {[]}  toValue = {this.toValue.bind(this)}/>}
